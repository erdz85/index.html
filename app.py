...
# 2. Storing the HTML as a Python list completely bypasses mobile spacing glitches!
html_lines = [
    "<!DOCTYPE html>",
    "<html>",
    "<head>",
    ...
    "        @media (min-width: 500px) { #game-container { height: 380px !important; } }",
    "    </style>",
    "</head>",
    "<body>",
...
# 3. Assemble the lines into a clean string block and play it
emulator_html = "\n".join(html_lines)
